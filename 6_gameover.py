...
# 화면 타이틀 설정
pygame.display.set_caption("Cheong Pang")
...
# 공 크기에 따른 최초  스피드
ball_speed_y = [-18, -15, -12, -9] # index 0 ~ 3 에 해당하는 값
...
balls.append({
    ...
    "to_x" : 3, # x축 이동방향, 양수면 오른쪽, 음수면 왼쪽
    "to_y" : -6, # y축 이동방향, 양수면 아래로, 음수면 위로
...
# 게임 종료 메세지 / TimeOver, Mission Complete, Game Over
